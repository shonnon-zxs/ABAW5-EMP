...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', type=str, default='/home/phankimngan/Projects/Affwild2-ABAW3-main/', help='Root data folder')
    parser.add_argument('--out_dir', type=str, default='/home/phankimngan/Projects/Affwild2-ABAW3-main/', help='Out data folder')
